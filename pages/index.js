...
limitBtnMonthly: 'Monthly â $2.99/mo',
limitBtnAnnual: 'Annual â $1.99/mo',
usageLeft: function(n) { return n + ' generation' + (n === 1 ? '' : 's') + ' left today'; },
shareMsg: 'Invite 5 friends â 5 extra generations',
shareBtn: 'ð² Share EzWrite',
shareWhatsappMsg: 'Try EzWrite for free â the AI that gives you 3 polished versions of any message: ',
...
'Espanol': {
tagline: 'EscribÃ­ tu mensaje. ElegÃ­ el tono y el idioma. ObtenÃ© 3 versiones pulidas.',
messageLabel: 'Tu mensaje',
placeholder: 'EscribÃ­ lo que querÃ©s decir, tan en bruto como quieras...',
toneLabel: 'Tono',
langLabel: 'Idioma del resultado',
moreLanguages: 'MÃ¡s idiomas',
...
installTitle: 'Acceso rÃ¡pido desde tu pantalla de inicio',
installBtn: 'Instalar app',
installBtnIos: 'Agregar a inicio',
iosStep1: 'TocÃ¡ el Ã­cono de compartir',
iosStep2: 'DeslizÃ¡ y tocÃ¡ "Agregar a pantalla de inicio"',
iosStep3: 'TocÃ¡ "Agregar" para confirmar',
installDismiss: 'Ahora no',
limitTitle: 'LÃ­mite diario alcanzado',
limitMsg: 'Usaste tus 5 generaciones gratuitas de hoy. SuscribÃ­te para seguir escribiendo.',
limitBtnMonthly: 'Mensual â $2.99/mes',
limitBtnAnnual: 'Anual â $1.99/mes',
usageLeft: function(n) { return n + (n === 1 ? ' generaciÃ³n restante' : ' generaciones restantes') + ' hoy'; },
shareMsg: 'InvitÃ¡ 5 amigos â 5 generaciones extra',
shareBtn: 'ð² Compartir EzWrite',
shareWhatsappMsg: 'ProbÃ¡ EzWrite gratis â la IA que te da 3 versiones de cualquier mensaje: ',
shareProgress: function(n) { return n + ' de 5'; },
recipientLabel: 'Destinatario (opcional)',
recipientOtherPlaceholder: 'Describi la relaciÃ³n...',
recipientOptions: ['Jefe/a', 'Cliente', 'Colega', 'Amigo/a', 'Pareja', 'Otro'],
tones: { 'Professional': 'Profesional', 'Direct': 'Directo', 'Diplomatic': 'DiplomÃ¡tico', 'Empathetic': 'EmpÃ¡tico', 'Firm': 'Firme' },
  versionLabel: 'VersiÃ³n',
langs: { 'Espanol': 'EspaÃ±ol', 'English': 'English', 'Portugues': 'PortuguÃ©s', 'French': 'FrancÃ©s', 'Italian': 'Italiano', 'German': 'AlemÃ¡n', 'Dutch': 'HolandÃ©s', 'Russian': 'Ruso', 'Chinese': 'Chino', 'Japanese': 'JaponÃ©s', 'Korean': 'Coreano', 'Arabic': 'Ãrabe', 'Hindi': 'Hindi', 'Turkish': 'Turco', 'Polish': 'Polaco', 'Ukrainian': 'Ucraniano', 'Greek': 'Griego', 'Hebrew': 'Hebreo', 'Swedish': 'Sueco', 'Norwegian': 'Noruego', 'Danish': 'DanÃ©s', 'Finnish': 'FinlandÃ©s', 'Czech': 'Checo', 'Romanian': 'Rumano', 'Hungarian': 'HÃºngaro', 'Vietnamese': 'Vietnamita', 'Thai': 'TailandÃ©s', 'Indonesian': 'Indonesio', 'Filipino': 'Filipino' }
},
'Portugues': {
...
installTitle: 'Acesso rÃ¡pido pela tela inicial',
installBtn: 'Instalar app',
installBtnIos: 'Adicionar Ã  tela inicial',
iosStep1: 'Toque no Ã­cone de compartilhar',
iosStep2: 'Deslize e toque em "Adicionar Ã  Tela de InÃ­cio"',
iosStep3: 'Toque em "Adicionar" para confirmar',
installDismiss: 'Agora nÃ£o',
limitTitle: 'Limite diÃ¡rio atingido',
limitMsg: 'VocÃª usou suas 5 geraÃ§Ãµes gratuitas de hoje. Assine para continuar escrevendo.',
limitBtnMonthly: 'Mensal â $2.99/mÃªs',
limitBtnAnnual: 'Anual â $1.99/mÃªs',
usageLeft: function(n) { return n + (n === 1 ? ' geraÃ§Ã£o restante' : ' geraÃ§Ãµes restantes') + ' hoje'; },
shareMsg: 'Convide 5 amigos â 5 geraÃ§Ãµes extras',
shareBtn: 'ð² Compartilhar EzWrite',
shareWhatsappMsg: 'Experimente o EzWrite grÃ¡tis â a IA que te dÃ¡ 3 versÃµes de qualquer mensagem: ',
shareProgress: function(n) { return n + ' de 5'; },
recipientLabel: 'DestinatÃ¡rio (opcional)',
recipientOtherPlaceholder: 'Descreva o relacionamento...',
recipientOptions: ['Chefe', 'Cliente', 'Colega', 'Amigo/a', 'Parceiro/a', 'Outro'],
tones: { 'Professional': 'Profissional', 'Direct': 'Direto', 'Diplomatic': 'DiplomÃ¡tico', 'Empathetic': 'EmpÃ¡tico', 'Firm': 'Firme' },
  versionLabel: 'VersÃ£o',
langs: { 'Espanol': 'Espanhol', 'English': 'Ingles', 'Portugues': 'Portugues', 'French': 'Frances', 'Italian': 'Italiano', 'German': 'Alemao', 'Dutch': 'Holandes', 'Russian': 'Russo', 'Chinese': 'Chines', 'Japanese': 'Japones', 'Korean': 'Coreano', 'Arabic': 'Arabe', 'Hindi': 'Hindi', 'Turkish': 'Turco', 'Polish': 'Polones', 'Ukrainian': 'Ucraniano', 'Greek': 'Grego', 'Hebrew': 'Hebraico', 'Swedish': 'Sueco', 'Norwegian': 'NorueguÃªs', 'Danish': 'Dinamarques', 'Finnish': 'Finlandes', 'Czech': 'Tcheco', 'Romanian': 'Romeno', 'Hungarian': 'Hungaro', 'Vietnamese': 'Vietnamita', 'Thai': 'Tailandes', 'Indonesian': 'Indonesio', 'Filipino': 'Filipino' }
}
};
...
{usageLeft <= 0 && !isSub && (<div style={{ background: '#FFF7ED', border: '1px solid #FED7AA', borderRadius: '10px', padding: '20px', marginTop: '1rem', textAlign: 'center' }}><div style={{ fontSize: '15px', fontWeight: 600, color: '#92400E', marginBottom: '6px' }}>{t.limitTitle}</div><div style={{ fontSize: '13px', color: '#B45309', marginBottom: '16px', lineHeight: 1.5 }}>{t.limitMsg}</div><div style={{ display: 'flex', gap: '8px', justifyContent: 'center', flexWrap: 'wrap' }}><a href={`https://ezwrite.lemonsqueezy.com/checkout/buy/301906ea-f048-4b2b-a72d-0734e8869e4a${userId ? "?checkout%5Bcustom%5D%5Buser_id%5D=" + encodeURIComponent(userId) : ""}&checkout%5Bredirect_url%5D=https://ezwrite-eight.vercel.app/?activated=1`} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', background: '#F59E0B', color: WHITE, padding: '10px 20px', borderRadius: '8px', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>{t.limitBtnMonthly}</a><a href={`https://ezwrite.lemonsqueezy.com/checkout/buy/fbe2aa91-d13b-4663-a043-f73b95f0884d${userId ? "?checkout%5Bcustom%5D%5Buser_id%5D=" + encodeURIComponent(userId) : ""}&checkout%5Bredirect_url%5D=https://ezwrite-eight.vercel.app/?activated=1`} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', background: WHITE, color: '#92400E', border: '1.5px solid #F59E0B', padding: '10px 20px', borderRadius: '8px', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>{t.limitBtnAnnual}</a></div></div>)}
