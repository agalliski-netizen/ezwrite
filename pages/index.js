...
<div style={{ marginTop: '3rem', paddingTop: '1.5rem', borderTop: '1px solid '+C.BORDER, textAlign: 'center', fontSize: '12px', color: C.TEXT3 }}>Made with <span style={{ color: C.ACCENT, fontWeight: 700 }}>EzWrite</span><span style={{ margin: '0 8px', opacity: 0.4 }}>·</span>Powered by <span style={{ color: '#E86A2D', fontWeight: 600 }}>Claude</span><span style={{ margin: '0 8px', opacity: 0.4 }}>·</span><a href="/blog" style={{ color: C.TEXT3, textDecoration: 'underline' }}>Blog</a><span style={{ margin: '0 8px', opacity: 0.4 }}>·</span><a href="/privacidad" style={{ color: C.TEXT3, textDecoration: 'underline' }}>{uiLang === 'Espanol' ? 'Privacidad' : uiLang === 'Portugues' ? 'Privacidade' : 'Privacy'}</a></div>
