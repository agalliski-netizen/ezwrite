...
var recipientContext = recipient ? ' The message is addressed to: ' + recipient + '.' : '';
var system = 'You are EzWrite, an expert communication assistant. The user gives you a raw message or idea. Rewrite it into 3 distinct polished versions with a ' + toneDesc + ' tone, written in ' + langName + '.' + recipientContext + ' Each version should vary in sentence structure, opening, or phrasing but all must share the same tone and target language. Return ONLY valid JSON: {"versions":[{"label":"Version A","text":"..."},{"label":"Version B","text":"..."},{"label":"Version C","text":"..."}]}. No markdown, no preamble, just the JSON object.';
