              ...
              var language = req.body.language;
                ...
                if (!message || !tone || !language) {
                    return res.status(400).json({ error: 'Missing fields' });
                        ...
                        var toneMap = {
                            'Profesional': 'professional and formal',
                                'Directo': 'direct and concise with no unnecessary filler',
                                    'Diplomatico': 'diplomatic and tactful, careful with wording',
                                        'Empatico': 'empathetic and warm, showing genuine care',
                                            'Firme': 'firm and assertive, holding a clear position'
                                              };
